...
// GetContextInfoWithContextText queries context info with context support (text protocol only).
...
// GetXMLContextWithContextText retrieves XML context using the text protocol (PRINT).
...
// ListDevicesWithContextText lists devices using the text protocol.
...
// GetChannelsWithContextText gets channels using the text protocol (LIST_CHANNELS).
...
// OpenBufferWithContextText opens a buffer using the text protocol (OPEN).
...
// ReadBufferWithContextText reads samples using the text protocol (READBUF).
...
// WriteBufferWithContextText writes buffer data using the text protocol (WRITEBUF).
...
// CloseBufferWithContextText closes the buffer using the text protocol (CLOSE).
